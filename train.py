...
def get_args_parser():
    ...
    parser.add_argument('--epochs', default=1000, type=int)#3500
    ...
    parser.add_argument('--data_root', default=r'D:\code\CrowdCounting-P2PNet\P2Pnet_dataset_crop',
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % args.eval_freq == 0 and epoch != 0:
            t1 = time.time()
            result = evaluate_crowd_no_overlap(model, data_loader_val, device,vis_dir='D:\code\CrowdCounting-P2PNet\eval')
            t2 = time.time()
